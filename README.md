...
> **Управление:** После установки доступно меню управления командой `geoserver`. Команда обновления скачивает новую версию `install.sh` и проверяет её синтаксис перед заменой.
